...
time_rewritten=$(time (../../../monpoly -formula ./formula-$2.txt -no_trigger -log ./log-$2.txt -sig ./signature.txt -no_rw -verified > ./out-rewritten.txt) 2>&1)
...
echo "$1;$2;$time_rewritten;$rewritten_meval_time;$time_native;$trigger_time;$native_meval_time"
